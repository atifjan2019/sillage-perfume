        ...
        <div className="min-h-screen flex" style={{ backgroundColor: "#0a0a0a", color: "#f5f5f5" }}>
            ...
            <aside className={`fixed inset-y-0 left-0 z-50 w-64 transform transition-transform duration-300 lg:translate-x-0 lg:static ${sidebarOpen ? "translate-x-0" : "-translate-x-full"}`}
                ...
                <div className="flex flex-col h-full">
                    ...
                    <div className="p-6 flex items-center justify-between">
                        <Link href="/admin">
                            <h1 className="text-xl tracking-[0.3em] font-light" style={{ fontFamily: "var(--font-playfair)", color: "var(--gold)" }}>
                                SILLAGE
                            </h1>
            ...
            <div className="flex-1 flex flex-col min-w-0">
                ...
                <header className="h-16 flex items-center px-4 sm:px-6 lg:hidden"
                    ...
                    <span className="ml-4 text-sm tracking-[0.2em]" style={{ fontFamily: "var(--font-playfair)", color: "var(--gold)" }}>
                        SILLAGE ADMIN
                    </span>
                </header>
