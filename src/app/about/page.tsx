...
export const metadata: Metadata = {
    title: "About | SWAN Perfumes",
    description: "Learn about SWAN — our story, our craft, and our commitment to luxury fragrances.",
};
        ...
        <div className="pt-20 sm:pt-24">
            <section className="py-16 sm:py-24 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
                ...
                <div className="space-y-8 text-sm leading-relaxed" style={{ color: "rgba(255,255,255,0.5)" }}>
                    <p>
                        Founded in 2024, SWAN was born from a singular vision: to create perfumes that transcend the ordinary and become extensions of one&apos;s identity. We believe that a truly great fragrance isn&apos;t just worn — it&apos;s experienced.
                    </p>
                    <p>
                    ...
                    <p>
                        Every SWAN fragrance undergoes a meticulous creation process that can span months. We don&apos;t rush perfection. Our compositions are layered with intention, designed to evolve on your skin throughout the day, revealing new facets with every passing hour.
                    </p>
                    ...
                    <p>
                        At SWAN, we are committed to sustainability and ethical sourcing. We work directly with farmers and distillers around the world, ensuring fair trade practices while maintaining the highest quality standards.
                    </p>
                </div>
            </section>
        </div>
